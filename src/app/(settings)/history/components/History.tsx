    ...
    return (
      <React.Fragment>
        ...
        {passengerCount.children > 0 && (
          <div
            className="flex mt-2"
            key={`${transactionDetails.id}-children`}
          >
        ...
        {passengerCount.baby > 0 && (
          <div
            className="flex mt-2"
            key={`${transactionDetails.id}-baby`}
          >
            <Labels>{passengerCount.baby} Baby</Labels>
            <Labels className="ml-auto">
              {formatPrice(totalPrice.baby)}
            </Labels>
          </div>
        )}
      </React.Fragment>
